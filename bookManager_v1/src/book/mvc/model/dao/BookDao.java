...
public class BookDao {
	...
	public int insertBook(Connection conn, Book bk) {
		int result = 0;
	...
	public int updateBook(Connection conn, Book bk) {
		int result = 0;
		PreparedStatement pstmt = null;
	...
	public ArrayList<Book> selectBookId(Connection conn, int bookId) {
		ArrayList<Book> blist = new ArrayList<>();
		PreparedStatement pstmt = null;
		ResultSet rset = null;
