...
public class EmployeeController {
	...
	public ArrayList<Employee> selectAll(){
		...
		ArrayList<Employee> empList = eservice.selcetList();
	...
	public ArrayList<Employee> selectJobId(String JobId) {
		...
		ArrayList<Employee> empList = eservice.selcetList(JobId);
	...
	public ArrayList<Employee> selectDeptId(String DeptId) {
		...
		ArrayList<Employee> empList = eservice.selectList(DeptId);
